...
import { SetselectedProducts } from '../redux/actions/ProductsAction'
...
export const ProductDetail = () => {
    ...
    const FetchProductDetail = async () => {
        const response = await axios.get(`https://aveosoft-react-assignment.herokuapp.com/products/${ProductId}`).catch((err) => console.log("Error"))
